...
// Tiny line chart for BTC/ETH preview
function TinyLineChart({ positive }: { positive: boolean }) {
  const color = positive ? '#22c55e' : '#ef4444'
  const path = positive 
    ? 'M0,20 C10,18 20,12 30,14 C40,16 50,8 60,6'
    : 'M0,6 C10,8 20,14 30,12 C40,10 50,16 60,18'
  return (
          ...
          {overview && (
            <div className="grid grid-cols-4 gap-3 mb-5">
              ...
              >
                ...
                <div className="flex items-center justify-between">
                  <TinyLineChart positive={overview.btcChange >= 0} />
                  <span 
              ...
              >
                ...
                <div className="flex items-center justify-between">
                  <TinyLineChart positive={overview.ethChange >= 0} />
                  <span 
                    className="text-[8px] tracking-widest px-2 py-0.5 rounded"
                    style={{ 
                      background: 'rgba(34,197,94,0.1)',
